...
import by.ArseniyTY.tasks_generators.math_tasks_generators.IntegerEquationMathTaskGenerator;
import by.ArseniyTY.tasks_generators.math_tasks_generators.IntegerExpressionMathTaskGenerator;
import by.ArseniyTY.tasks_generators.math_tasks_generators.RealEquationMathTaskGenerator;
import by.ArseniyTY.tasks_generators.math_tasks_generators.RealExpressionMathTaskGenerator;
...
public class Program {
    private static Map<String, Quiz> getQuizMap() throws NotHandledEnumElementException, IncorrectTaskConditionsException {
        ...
        var intExpTG1 = new IntegerExpressionMathTaskGenerator(-10, 10,
        ...
        var intEqTG1 = new IntegerEquationMathTaskGenerator(-10, 10,
                EnumSet.of(MathOperatorType.SUM, MathOperatorType.DIFFERENCE, MathOperatorType.MULTIPLICATION,
                        MathOperatorType.DIVISION));
        quizMap.put("IEq", new Quiz(intEqTG1, 2));

        var realExpTG1 = new RealExpressionMathTaskGenerator(2, -10, 10,
                EnumSet.of(MathOperatorType.SUM, MathOperatorType.DIFFERENCE, MathOperatorType.MULTIPLICATION,
                        MathOperatorType.DIVISION));
        quizMap.put("REx", new Quiz(realExpTG1, 2));

        var realEqTG1 = new RealEquationMathTaskGenerator(2, -10, 10,
                EnumSet.of(MathOperatorType.SUM, MathOperatorType.DIFFERENCE, MathOperatorType.MULTIPLICATION,
                        MathOperatorType.DIVISION));
        ...
        var intEqTG2 = new IntegerEquationMathTaskGenerator(0, 1,
                EnumSet.of(MathOperatorType.DIVISION));
        quizMap.put("IEq2", new Quiz(intEqTG2, 10));

        var poolTG2 = new PoolTaskGenerator(false,
                new IntegerEquationMathTask(0, 0, MathOperatorType.MULTIPLICATION),
                new RealExpressionMathTask(2, 0.01, 2, MathOperatorType.DIVISION),
