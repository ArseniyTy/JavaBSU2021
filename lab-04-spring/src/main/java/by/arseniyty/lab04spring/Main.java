...
public class Main {
    ...
    // TODO: связать пользователей с вопросами и лайками,
    //  пользователь может удалить свой вопрос, свой коммент, убрать свой лайк если он был,
    //  или поставить лайк если его не было.
    // TODO: форма регистрация красивая, и чтобы ошибки высвечивались пользователю тоже
